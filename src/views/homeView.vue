...
<template>
  <div class="flex justify-center pt-24">
    <div class="w-[751px] h-full pt-3 pb-4 px-5 bg-homeCard bg-opacity-5 rounded-[10px]">
      <div class="w-full flex justify-between items-center">
        ...
        <div class="w-60 h-10 rounded-md bg-homeCard bg-opacity-5 border-2 border-transparent flex flex-row-reverse items-center px-2">
          <input type="text" v-model="searchQuery" @input="performSearch" placeholder="Suchen" class="w-full h-full text-xs md:text-sm lg:text-base bg-transparent text-white placeholder-opacity-50 outline-none pl-2 peer"/>
